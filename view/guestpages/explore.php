                            ...
                            <div class="row row-cols-auto">
                                <div class="col">
                                    <div class="col">
                                        ...
                                        <div class="mb-1 text-muted"><?php echo $randomPostArray['created_at'] ?> | Por: <a href="otherUser.php?user=<?php echo $randomPostArray['iduser'] ?>"><?php echo $randomPostArray['userName'] ?></a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row row-cols-auto">
