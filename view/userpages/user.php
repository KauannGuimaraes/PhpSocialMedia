                    ...
                    <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                        <div class="col p-4 d-flex flex-column position-static">
                            <div class="row row-cols-auto">
                                <div class="col">
                                    <p class="h4"><?php echo $userName?></p>
                                    <div class="mb-1 text-muted">Usuario registrado em: <?php echo $userCreated ?></div>
                                    <p class="h4"><?php echo $userDescription ?></p>
                                    <p class="h4"><?php echo $userEmail ?></p>
                                    <p class="h4">Postagens <a href="publicacao.php"><?php echo $countPost ?></a></p>
                                </div>
                                <div class="col">
                                    <a href="../controller/logoutExecute.php" class="btn">
                                        Log out
                                    </a>
                                </div>
                            </div>
